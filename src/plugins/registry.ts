...
import type {
  FoxClawPluginApi,
  FoxClawPluginChannelRegistration,
  FoxClawPluginCliRegistrar,
  FoxClawPluginCommandDefinition,
  FoxClawPluginHttpRouteAuth,
  FoxClawPluginHttpRouteMatch,
  FoxClawPluginHttpRouteHandler,
  FoxClawPluginHttpRouteParams,
  FoxClawPluginHookOptions,
  ProviderPlugin,
  FoxClawPluginService,
  FoxClawPluginToolContext,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: FoxClawPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: FoxClawPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: FoxClawPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: FoxClawPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: FoxClawPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: FoxClawPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: FoxClawPluginHookOptions | undefined,
    config: FoxClawPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: FoxClawPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: FoxClawPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as FoxClawPluginChannelRegistration).plugin === "object"
        ? (registration as FoxClawPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: FoxClawPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: FoxClawPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: FoxClawPluginCommandDefinition) => {
