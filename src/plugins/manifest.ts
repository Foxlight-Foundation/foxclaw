...
export const PLUGIN_MANIFEST_FILENAME = "foxclaw.plugin.json";
...
// package.json "foxclaw" metadata (used for onboarding/catalog)
...
export type FoxClawPackageManifest = {
  extensions?: string[];
...
): FoxClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
