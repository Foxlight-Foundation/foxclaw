...
describe("bundled plugin sources", () => {
      ...
      candidates: [
        {
          ...
          packageName: "@foxclaw/feishu",
          packageManifest: { install: { npmSpec: "@foxclaw/feishu" } },
        },
        {
          origin: "bundled",
        ...
        },
        {
          ...
          packageName: "@foxclaw/msteams",
          packageManifest: { install: { npmSpec: "@foxclaw/msteams" } },
        },
      ],
      diagnostics: [],
    });
  ...
  it("finds bundled source by npm spec", () => {
    ...
    const resolved = findBundledPluginSource({
      lookup: { kind: "npmSpec", value: "@foxclaw/feishu" },
    });
    const missing = findBundledPluginSource({
      lookup: { kind: "npmSpec", value: "@foxclaw/not-found" },
    });
      ...
      candidates: [
        {
          ...
          packageName: "@foxclaw/diffs",
          packageManifest: { install: { npmSpec: "@foxclaw/diffs" } },
        },
      ],
      diagnostics: [],
    });
