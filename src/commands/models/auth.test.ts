...
describe("modelsAuthLoginCommand", () => {
  ...
  let currentConfig: FoxClawConfig;
  let lastUpdatedConfig: FoxClawConfig | null;
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/foxclaw/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/foxclaw/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/foxclaw/workspace");
    mocks.loadValidConfigOrThrow.mockImplementation(async () => currentConfig);
    mocks.updateConfig.mockImplementation(
      async (mutator: (cfg: FoxClawConfig) => FoxClawConfig) => {
  ...
  it("clears stale auth lockouts before attempting openai-codex login", async () => {
    ...
    expect(mocks.clearAuthProfileCooldown).toHaveBeenCalledWith({
      ...
      agentDir: "/tmp/foxclaw/agents/main",
    });
  ...
  it("loads lockout state from the agent-scoped store", async () => {
    ...
    expect(mocks.loadAuthProfileStoreForRuntime).toHaveBeenCalledWith("/tmp/foxclaw/agents/main");
  });
