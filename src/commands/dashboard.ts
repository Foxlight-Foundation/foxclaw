...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set FOXCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `foxclaw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control FoxClaw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
