...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.foxclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("foxclaw hooks list")}`,
      `  ${formatCliCommand("foxclaw hooks enable <name>")}`,
      `  ${formatCliCommand("foxclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
