...
function resolveDefaultAccountId(cfg: FoxClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: FoxClawConfig): boolean {
...
export function summarizeBindings(cfg: FoxClawConfig, bindings: AgentBinding[]): string[] {
