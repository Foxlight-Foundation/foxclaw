...
export function applyVercelAiGatewayProviderConfig(cfg: FoxClawConfig): FoxClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: FoxClawConfig): FoxClawConfig {
