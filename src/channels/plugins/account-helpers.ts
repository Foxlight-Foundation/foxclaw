...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: FoxClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: FoxClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: FoxClawConfig): string {
