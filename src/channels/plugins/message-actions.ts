...
export function listChannelMessageActions(cfg: FoxClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: FoxClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: FoxClawConfig): boolean {
