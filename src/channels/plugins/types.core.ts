...
export type ChannelAgentToolFactory = (params: { cfg?: FoxClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: FoxClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: FoxClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: FoxClawConfig }) => boolean;
  supportsCards?: (params: { cfg: FoxClawConfig }) => boolean;
