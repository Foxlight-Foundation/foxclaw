...
import { discoverFoxClawPlugins } from "../../plugins/discovery.js";
import type { FoxClawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, FoxClawPackageManifest>>;

const ENV_CATALOG_PATHS = ["FOXCLAW_PLUGIN_CATALOG_PATHS", "FOXCLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<FoxClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: FoxClawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: FoxClawPackageManifest;
