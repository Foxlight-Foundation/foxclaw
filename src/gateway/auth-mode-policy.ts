...
export function hasAmbiguousGatewayAuthModeConfig(cfg: FoxClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: FoxClawConfig): void {
