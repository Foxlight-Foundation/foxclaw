...
export function resolveHooksConfig(cfg: FoxClawConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: FoxClawConfig, defaultAgentId: string): Set<string> {
...
export function resolveHookIdempotencyKey(params: {
  ...
  return (
    ...
    resolveOptionalHookIdempotencyKey(params.headers?.["x-foxclaw-idempotency-key"]) ||
