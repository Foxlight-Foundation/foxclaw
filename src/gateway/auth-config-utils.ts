import type { GatewayAuthConfig, FoxClawConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: FoxClawConfig, password: string): FoxClawConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
