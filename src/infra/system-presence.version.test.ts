...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when FOXCLAW_VERSION is not set", async () => {
  ...
  it("prefers FOXCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over FOXCLAW_SERVICE_VERSION when FOXCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        FOXCLAW_VERSION: " ",
        FOXCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when FOXCLAW_VERSION and FOXCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        FOXCLAW_VERSION: " ",
        FOXCLAW_SERVICE_VERSION: "\t",
