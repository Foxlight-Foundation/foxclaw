...
export function isAcpEnabledByPolicy(cfg: FoxClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: FoxClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: FoxClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: FoxClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: FoxClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: FoxClawConfig, agentId: string): boolean {
