...
function resolveAnthropicDefaultAuthMode(cfg: FoxClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: FoxClawConfig): FoxClawConfig {
...
export function applyTalkApiKey(config: FoxClawConfig): FoxClawConfig {
...
export function applyTalkConfigNormalization(config: FoxClawConfig): FoxClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: FoxClawConfig): FoxClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: FoxClawConfig): FoxClawConfig {
...
export function applyLoggingDefaults(cfg: FoxClawConfig): FoxClawConfig {
...
export function applyContextPruningDefaults(cfg: FoxClawConfig): FoxClawConfig {
...
export function applyCompactionDefaults(cfg: FoxClawConfig): FoxClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
