...
import {
  ...
  DEFAULT_FOXCLAW_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_FOXCLAW_BROWSER_COLOR;
  }
...
/**
 * Ensure the default "foxclaw" profile exists in the profiles map.
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_FOXCLAW_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_FOXCLAW_BROWSER_PROFILE_NAME] = {
...
export function resolveBrowserConfig(
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ? DEFAULT_BROWSER_DEFAULT_PROFILE_NAME
      : profiles[DEFAULT_FOXCLAW_BROWSER_PROFILE_NAME]
        ? DEFAULT_FOXCLAW_BROWSER_PROFILE_NAME
        : "user");
