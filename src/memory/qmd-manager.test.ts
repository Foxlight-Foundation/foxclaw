...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: FoxClawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: FoxClawConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__foxclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__foxclawMcporterColdStartWarned;
  });
