...
export function listAuthProfileStorePaths(config: FoxClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: FoxClawConfig, stateDir: string): string[] {
