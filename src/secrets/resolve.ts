...
function resolveResolutionLimits(config: FoxClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: FoxClawConfig): SecretProviderConfig {
