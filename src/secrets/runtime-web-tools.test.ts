...
async function runRuntimeWebTools(params: { config: FoxClawConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: FoxClawConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
