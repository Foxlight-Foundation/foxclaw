/**
 * Hook system for FoxClaw agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __foxclaw_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__foxclaw_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
