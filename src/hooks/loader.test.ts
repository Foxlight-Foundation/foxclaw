...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "foxclaw-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["FOXCLAW_BUNDLED_HOOKS_DIR"]);
    process.env.FOXCLAW_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: FoxClawConfig) => {
