    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["foxclaw channels list", "List configured channels and auth profiles."],
          ["foxclaw channels status --probe", "Run channel status checks and probes."],
          [
            "foxclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["foxclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.foxclaw.ai/cli/channels",
        )}\n`,
    );
