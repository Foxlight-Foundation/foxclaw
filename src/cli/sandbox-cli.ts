...
const SANDBOX_EXAMPLES = {
  main: [
    ["foxclaw sandbox list", "List all sandbox containers."],
    ["foxclaw sandbox list --browser", "List only browser containers."],
    ["foxclaw sandbox recreate --all", "Recreate all containers."],
    ["foxclaw sandbox recreate --session main", "Recreate a specific session."],
    ["foxclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["foxclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["foxclaw sandbox list", "List all sandbox containers."],
    ["foxclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["foxclaw sandbox recreate --all", "Recreate all containers."],
    ["foxclaw sandbox recreate --session main", "Recreate a specific session."],
    ["foxclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["foxclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["foxclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["foxclaw sandbox explain", "Show effective sandbox config."],
    ["foxclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["foxclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["foxclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.foxclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
