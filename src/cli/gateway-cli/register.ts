      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["foxclaw gateway run", "Run the gateway in the foreground."],
            ["foxclaw gateway status", "Show service status and probe reachability."],
            ["foxclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["foxclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.foxclaw.ai/cli/gateway")}\n`,
      ),
  );
