    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["foxclaw directory self --channel slack", "Show the connected account identity."],
          [
            'foxclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["foxclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "foxclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.foxclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
