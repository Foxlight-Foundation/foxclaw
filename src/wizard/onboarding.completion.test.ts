...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("foxclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "foxclaw");
