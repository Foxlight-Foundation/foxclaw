...
export function resolveSessionToolsVisibility(cfg: FoxClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: FoxClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: FoxClawConfig): AgentToAgentPolicy {
