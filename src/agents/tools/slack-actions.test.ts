...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): FoxClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: FoxClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: FoxClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
