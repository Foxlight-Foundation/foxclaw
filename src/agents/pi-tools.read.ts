...
function resolveAdaptiveReadMaxBytes(options?: FoxClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createFoxClawReadTool(base, {
...
export function createFoxClawReadTool(
  base: AnyAgentTool,
  options?: FoxClawReadToolOptions,
): AnyAgentTool {
