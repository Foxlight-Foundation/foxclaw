...
function resolveAvatarSource(cfg: FoxClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: FoxClawConfig, agentId: string): AgentAvatarResolution {
