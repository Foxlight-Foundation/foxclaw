...
export const DEFAULT_SANDBOX_IMAGE = "foxclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "foxclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "foxclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "foxclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "foxclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "foxclaw-sandbox-browser";
