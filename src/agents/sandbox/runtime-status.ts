...
function resolveMainSessionKeyForSandbox(params: { cfg?: FoxClawConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: FoxClawConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`foxclaw sandbox explain --session ${runtime.sessionKey}`)}`,
  );
