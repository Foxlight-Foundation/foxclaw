...
type ModelsConfig = NonNullable<FoxClawConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier FoxClaw docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // FoxClaw keeps auth in auth-profiles and resolves runtime availability from that store.
