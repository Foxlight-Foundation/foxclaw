...
async function resolveContext(config: FoxClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): FoxClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
