    ...
    plugins: [
      {
        ...
        manifestPath: path.join(params.acpxRoot, "foxclaw.plugin.json"),
      },
      {
        id: "helper",
        name: "Helper",
        ...
        manifestPath: path.join(params.helperRoot, "foxclaw.plugin.json"),
      },
    ],
  };
}
    ...
    plugins: [
      {
        ...
        manifestPath: path.join(params.pluginRoot, "foxclaw.plugin.json"),
      },
    ],
  };
}
