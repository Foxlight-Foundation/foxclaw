...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/foxclaw/foxclaw/issues/31298
    previousFastTestEnv = process.env.FOXCLAW_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.FOXCLAW_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // FOXCLAW_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("FoxClaw runtime context (internal):");
