...
const CLEANUP_STATE_KEY = Symbol.for("foxclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("foxclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("foxclaw.sessionWriteLockWatchdogState");
