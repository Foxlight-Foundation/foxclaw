...
function resolvePostCompactionIndexSyncMode(config?: FoxClawConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureFoxClawModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createFoxClawCodingTools({
      exec: {
