...
import { resolveFoxClawDocsPath } from "../../docs-path.js";
...
import { createFoxClawCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
const SESSIONS_YIELD_INTERRUPT_CUSTOM_TYPE = "foxclaw.sessions_yield_interrupt";
const SESSIONS_YIELD_CONTEXT_CUSTOM_TYPE = "foxclaw.sessions_yield";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveFoxClawAgentDir();
    ...
    const runtimeCapabilities = runtimeChannel
      ...
      : undefined;
    // Channel-specific inline buttons and reaction guidance are resolved
    // by plugins at runtime; no hardcoded channel logic here.
    ...
    const docsPath = await resolveFoxClawDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/foxclaw/foxclaw/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("foxclaw:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/foxclaw/foxclaw/issues/8643
