...
function resolveAnthropicOpusThinking(cfg: FoxClawConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<FoxClawConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<FoxClawConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<FoxClawConfig> = {
        agents: {
          defaults: {
            models: {
