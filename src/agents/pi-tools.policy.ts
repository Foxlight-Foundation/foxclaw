...
export function resolveSubagentToolPolicy(cfg?: FoxClawConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: FoxClawConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: FoxClawConfig["tools"];
