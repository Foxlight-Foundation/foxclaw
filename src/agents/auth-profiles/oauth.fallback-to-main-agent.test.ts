...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveFoxClawAgentDir() returns mainAgentDir
    process.env.FOXCLAW_STATE_DIR = tmpDir;
    process.env.FOXCLAW_AGENT_DIR = mainAgentDir;
