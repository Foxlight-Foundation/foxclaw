...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.FOXCLAW_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.FOXCLAW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.FOXCLAW_SERVICE_MARKER = originalServiceMarker;
    }
  });
