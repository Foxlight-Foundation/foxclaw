...
export function listBindings(cfg: FoxClawConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: FoxClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: FoxClawConfig) {
