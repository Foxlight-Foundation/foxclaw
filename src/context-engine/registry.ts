...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("foxclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: FoxClawConfig): Promise<ContextEngine> {
