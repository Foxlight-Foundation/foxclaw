...
function resolveAcpStreamCoalesceIdleMs(cfg: FoxClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: FoxClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: FoxClawConfig): AcpProjectionSettings {
