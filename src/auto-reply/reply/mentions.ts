...
function resolveMentionPatterns(cfg: FoxClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: FoxClawConfig | undefined, agentId?: string): RegExp[] {
