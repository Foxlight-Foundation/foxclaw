...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@foxclaw", { botUsername: "foxclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@foxclaw args", {
        botUsername: "foxclaw",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "foxclaw" })).toBe(
      "/help@otherbot",
    );
  });
