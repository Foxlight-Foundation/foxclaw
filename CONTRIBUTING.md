# Contributing to FoxClaw

Welcome to the lobster tank! 🦞

## Quick Links

- **GitHub:** https://github.com/foxclaw/foxclaw
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@foxclaw](https://x.com/foxclaw)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/foxclaw/foxclaw/discussions) or ask in Discord first
...
- Test locally with your FoxClaw instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for FoxClaw skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/foxclaw/foxclaw/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape FoxClaw's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@foxclaw.ai with:

- Links to your PRs on FoxClaw (if you don't have any, start there first)
...
- **Core CLI and gateway** — [foxclaw/foxclaw](https://github.com/foxclaw/foxclaw)
- **macOS desktop app** — [foxclaw/foxclaw](https://github.com/foxclaw/foxclaw) (apps/macos)
- **iOS app** — [foxclaw/foxclaw](https://github.com/foxclaw/foxclaw) (apps/ios)
- **Android app** — [foxclaw/foxclaw](https://github.com/foxclaw/foxclaw) (apps/android)
- **ClawHub** — [foxclaw/clawhub](https://github.com/foxclaw/clawhub)
- **Trust and threat model** — [foxclaw/trust](https://github.com/foxclaw/trust)

For issues that don't fit a specific repo, or if you're unsure, email **security@foxclaw.ai** and we'll route it.
