...
# Output:
# - dist/FoxClaw.app
# - dist/FoxClaw-<version>.zip
# - dist/FoxClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.foxclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/FoxClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/FoxClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/FoxClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FoxClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/FoxClaw-$VERSION.dSYM.zip"
