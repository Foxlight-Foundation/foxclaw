...
- FOXCLAW_GATEWAY_VERSION = exact package.json version
- FOXCLAW_MARKETING_VERSION = short iOS/App Store version
- FOXCLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
FOXCLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
FOXCLAW_MARKETING_VERSION = ${MARKETING_VERSION}
FOXCLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
