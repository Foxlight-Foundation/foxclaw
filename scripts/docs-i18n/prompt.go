...
- Keep product names in English: FoxClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the FoxClaw Gateway, use “Gateway 网关”.
