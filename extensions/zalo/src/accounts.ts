...
import { createAccountListHelpers, type FoxClawConfig } from "foxclaw/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: FoxClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: FoxClawConfig): ResolvedZaloAccount[] {
