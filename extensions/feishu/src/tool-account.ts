...
import type { FoxClawPluginApi } from "foxclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: FoxClawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<FoxClawPluginApi, "config">;
