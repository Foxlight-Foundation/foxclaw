...
function mergeIMessageAccountConfig(cfg: FoxClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: FoxClawConfig): ResolvedIMessageAccount[] {
