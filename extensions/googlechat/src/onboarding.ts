import type { FoxClawConfig, DmPolicy } from "foxclaw/plugin-sdk/googlechat";
import {
  DEFAULT_ACCOUNT_ID,
...
} from "foxclaw/plugin-sdk/googlechat";
import {
...
function setGoogleChatDmPolicy(cfg: FoxClawConfig, policy: DmPolicy) {
  const allowFrom =
    policy === "open"
