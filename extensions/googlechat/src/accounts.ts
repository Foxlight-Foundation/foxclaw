...
import { isSecretRef } from "foxclaw/plugin-sdk/googlechat";
import { createAccountListHelpers, type FoxClawConfig } from "foxclaw/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: FoxClawConfig): ResolvedGoogleChatAccount[] {
