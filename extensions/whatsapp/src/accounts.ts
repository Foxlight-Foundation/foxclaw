...
export function listWhatsAppAuthDirs(cfg: FoxClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: FoxClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: FoxClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: FoxClawConfig): ResolvedWhatsAppAccount[] {
