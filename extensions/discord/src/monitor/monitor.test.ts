...
describe("agent components", () => {
  const createCfg = (): FoxClawConfig => ({}) as FoxClawConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/foxclaw-sessions-test.json");
  });
