import { createScopedChannelConfigBase } from "foxclaw/plugin-sdk/compat";
import {
...
} from "foxclaw/plugin-sdk/discord";
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). FoxClaw adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
