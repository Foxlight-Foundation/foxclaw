...
} from "foxclaw/plugin-sdk/account-id";
import type { FoxClawConfig } from "foxclaw/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: FoxClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: FoxClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: FoxClawConfig): string {
