import { AllowFromListSchema, DmPolicySchema } from "foxclaw/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "foxclaw/plugin-sdk/nostr";
import { z } from "zod";
