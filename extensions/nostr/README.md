...
Nostr DM channel plugin for FoxClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to FoxClaw. It enables your bot to:
...
# Configure foxclaw to use local relay
