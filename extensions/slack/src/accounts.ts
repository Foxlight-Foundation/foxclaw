...
export function mergeSlackAccountConfig(cfg: FoxClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: FoxClawConfig): ResolvedSlackAccount[] {
