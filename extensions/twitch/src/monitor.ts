...
import type { ReplyPayload, FoxClawConfig } from "foxclaw/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "foxclaw/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as FoxClawConfig;
