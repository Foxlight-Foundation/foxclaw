...
import type { FoxClawPluginApi } from "foxclaw/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("foxclaw/plugin-sdk/mattermost").FoxClawConfig;
    runtime: import("foxclaw/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: FoxClawPluginApi) {
