...
export { createDedupeCache, rawDataToString } from "foxclaw/plugin-sdk/mattermost";
...
function listAgents(cfg: FoxClawConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: FoxClawConfig, agentId: string): string | undefined {
