...
import { createAccountListHelpers, type FoxClawConfig } from "foxclaw/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: FoxClawConfig): ResolvedMattermostAccount[] {
