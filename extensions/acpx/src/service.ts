import type {
  ...
  PluginLogger,
} from "foxclaw/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "foxclaw/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: FoxClawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: FoxClawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
