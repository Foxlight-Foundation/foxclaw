import type { FoxClawConfig, FoxClawPluginApi } from "openclaw/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: FoxClawConfig): { id: string; name: string } {
