import type { FoxClawConfig, PluginRuntime, ResolvedLineAccount } from "foxclaw/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: FoxClawConfig; accountId: string }): Promise<{
