...
import { fetchWithSsrFGuard } from "foxclaw/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to FoxClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".foxclaw", "workspace", "media", "inbound");
 ...
 * Format matches FoxClaw's expected attachment structure.
 */
