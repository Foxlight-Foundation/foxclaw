...
} from "foxclaw/plugin-sdk/zalouser";
import {
...
function resolveZalouserOutboundChunkMode(cfg: FoxClawConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: FoxClawConfig, accountId?: string) {
