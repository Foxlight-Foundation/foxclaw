import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "foxclaw/plugin-sdk/account-id";
import { createAccountListHelpers, type FoxClawConfig } from "foxclaw/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: FoxClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: FoxClawConfig; accountId?: string | null }) {
