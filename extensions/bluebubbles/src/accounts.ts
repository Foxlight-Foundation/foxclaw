...
import { createAccountListHelpers, type FoxClawConfig } from "foxclaw/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: FoxClawConfig): ResolvedBlueBubblesAccount[] {
