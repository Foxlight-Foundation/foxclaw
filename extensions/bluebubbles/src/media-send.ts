...
import { resolveChannelMediaMaxBytes, type FoxClawConfig } from "foxclaw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: FoxClawConfig; accountId?: string }): string[] {
