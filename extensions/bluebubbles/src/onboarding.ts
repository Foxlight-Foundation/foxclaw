import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "foxclaw/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setBlueBubblesDmPolicy(cfg: FoxClawConfig, dmPolicy: DmPolicy): FoxClawConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your FoxClaw gateway URL + webhook path",
