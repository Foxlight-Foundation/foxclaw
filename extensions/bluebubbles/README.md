...
This directory contains the **BlueBubbles external channel plugin** for FoxClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `foxclaw/plugin-sdk` helpers.
