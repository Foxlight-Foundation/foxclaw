...
function mergeSignalAccountConfig(cfg: FoxClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: FoxClawConfig): ResolvedSignalAccount[] {
