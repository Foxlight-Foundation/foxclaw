...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/foxclaw/foxclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/foxclaw/foxclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://foxclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "FoxClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FoxClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "FoxClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FoxClawGitCommit") as? String) ??
            "unknown"
    }
