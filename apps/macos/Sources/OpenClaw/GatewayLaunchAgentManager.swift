...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.foxclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".foxclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.foxclawCommand(
            subcommand: "gateway",
