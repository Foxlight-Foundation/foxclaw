...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.foxclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("FoxClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__foxclaw__/a2ui/").absoluteString + "?platform=macos"
    }
