...
enum UIStrings {
    static let welcomeTitle = "Welcome to FoxClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "foxclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: FoxClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g foxclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: FoxClawChatViewModel(
