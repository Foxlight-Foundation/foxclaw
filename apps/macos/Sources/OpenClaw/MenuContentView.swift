...
/// Menu contents for the FoxClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About FoxClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "FoxClaw Not Configured"
        case .remote:
            "Remote FoxClaw Active"
        case .local:
            "FoxClaw Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .foxclawSelectSettingsTab, object: tab)
        }
    }
