...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .foxclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? FoxClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? FoxClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let foxclawSelectSettingsTab = Notification.Name("foxclawSelectSettingsTab")
}
