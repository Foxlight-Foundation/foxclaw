...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = FoxClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = FoxClawConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: FoxClawConfigFile.loadDict(),
        ...
        FoxClawConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/foxclaw"
        state.remoteCliPath = ""
        return state
    }
}
