...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.foxclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return FoxClawConfigFile.defaultWorkspaceURL() }
