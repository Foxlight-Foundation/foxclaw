...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.foxclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other FoxClaw windows, but below the system’s pop-up menus.
