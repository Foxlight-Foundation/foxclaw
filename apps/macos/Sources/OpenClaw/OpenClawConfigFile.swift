...
enum FoxClawConfigFile {
    private static let logger = Logger(subsystem: "ai.foxclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        FoxClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        FoxClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-foxclaw-config-file",
            "event": "config.write",
