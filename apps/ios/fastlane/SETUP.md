...
ASC_KEYCHAIN_SERVICE=foxclaw-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.foxclaw.client
# or
...
- The beta flow regenerates `apps/ios/FoxClaw.xcodeproj` from `apps/ios/project.yml` before archiving
