...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.foxclaw.ios", category: "LiveActivity")
    private var currentActivity: Activity<FoxClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = FoxClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<FoxClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: FoxClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> FoxClawActivityAttributes.ContentState {
        FoxClawActivityAttributes.ContentState(
    ...
    private func idleState() -> FoxClawActivityAttributes.ContentState {
        FoxClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> FoxClawActivityAttributes.ContentState {
        FoxClawActivityAttributes.ContentState(
