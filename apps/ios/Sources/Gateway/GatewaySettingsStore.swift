...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.foxclaw.gateway"
    private static let nodeService = "ai.foxclaw.node"
    private static let talkService = "ai.foxclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.foxclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.foxclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("foxclaw-gateway.log")
    }
