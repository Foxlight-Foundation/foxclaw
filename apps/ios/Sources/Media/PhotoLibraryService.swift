...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: FoxClawPhotosLatestParams) async throws -> FoxClawPhotosLatestPayload {
        ...
        var results: [FoxClawPhotoPayload] = []
        ...
        return FoxClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> FoxClawPhotoPayload
    {
