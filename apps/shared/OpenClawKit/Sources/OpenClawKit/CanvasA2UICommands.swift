...
public enum FoxClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct FoxClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct FoxClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
