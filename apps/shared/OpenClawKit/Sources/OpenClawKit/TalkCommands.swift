...
public enum FoxClawTalkCommand: String, Codable, Sendable {
...
public struct FoxClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct FoxClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
