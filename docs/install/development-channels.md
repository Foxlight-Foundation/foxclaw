...
FoxClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, FoxClaw also aligns
the install method:
...
When you switch channels with `foxclaw update`, FoxClaw also syncs plugin sources:
