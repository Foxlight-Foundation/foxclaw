...
本指南总结了在 FoxClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 FoxClaw 状态目录下。默认为 `~/.foxclaw`。如果设置了 `FOXCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.foxclaw.ai/testing
- https://docs.foxclaw.ai/start/getting-started
