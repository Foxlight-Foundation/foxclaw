...
“Pairing” is FoxClaw’s explicit **owner approval** step.
...
Stored under `~/.foxclaw/credentials/`:
...
- The legacy `node.pair.*` API (CLI: `foxclaw nodes pending/approve`) is a
