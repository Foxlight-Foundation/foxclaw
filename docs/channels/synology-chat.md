---
summary: "Synology Chat webhook setup and FoxClaw config"
read_when:
  - Setting up Synology Chat with FoxClaw
...
```bash
foxclaw plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your FoxClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in FoxClaw.
...
- Pairing approvals work with:
  - `foxclaw pairing list synology-chat`
  - `foxclaw pairing approve synology-chat <CODE>`
...
```bash
foxclaw message send --channel synology-chat --target 123456 --text "Hello from FoxClaw"
foxclaw message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
