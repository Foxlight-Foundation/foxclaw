...
- Install via CLI: `foxclaw plugins install @foxclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `foxclaw plugins install ./extensions/zalo`
   - From npm (if published): `foxclaw plugins install @foxclaw/zalo`
...
- Approve via:
  - `foxclaw pairing list zalo`
  - `foxclaw pairing approve zalo <CODE>`
...
- Example: `foxclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `foxclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `foxclaw logs --follow`
