...
read_when:
  - You are building a FoxClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (foxclaw.plugin.json)

Every plugin **must** ship a `foxclaw.plugin.json` file in the **plugin root**.
FoxClaw uses this manifest to validate configuration **without executing plugin
