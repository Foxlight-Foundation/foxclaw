---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with FoxClaw"
read_when:
  - You want Xiaomi MiMo models in FoxClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). FoxClaw uses
