---
summary: "Use Qwen OAuth (free tier) in FoxClaw"
read_when:
  - You want to use Qwen with FoxClaw
...
If you already logged in with the Qwen Code CLI, FoxClaw will sync credentials
