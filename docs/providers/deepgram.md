...
Deepgram is a speech-to-text API. In FoxClaw it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, FoxClaw uploads the audio file to Deepgram and injects the transcript
