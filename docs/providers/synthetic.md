---
summary: "Use Synthetic's Anthropic-compatible API in FoxClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. FoxClaw registers it as the
...
Note: FoxClaw's Anthropic client appends `/v1` to the base URL, so use
