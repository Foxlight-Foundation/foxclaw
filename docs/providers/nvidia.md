---
summary: "Use NVIDIA's OpenAI-compatible API in FoxClaw"
read_when:
  - You want to use NVIDIA models in FoxClaw
...
foxclaw onboard --auth-choice skip
foxclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
