---
summary: "Use Qianfan's unified API to access many models in FoxClaw"
read_when:
...
3. FoxClaw installed on your system
...
4. Copy the API key for use with FoxClaw

## CLI setup

```bash
foxclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [FoxClaw Configuration](/gateway/configuration)
