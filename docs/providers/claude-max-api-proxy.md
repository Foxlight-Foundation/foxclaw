...
You can point FoxClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or FoxClaw
...
- [Anthropic provider](/providers/anthropic) - Native FoxClaw integration with Claude setup-token or API keys
