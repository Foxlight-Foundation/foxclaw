---
summary: "Overview of FoxClaw onboarding options and flows"
read_when:
...
FoxClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`foxclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the FoxClaw app when you want a fully guided setup on macOS. Docs:
