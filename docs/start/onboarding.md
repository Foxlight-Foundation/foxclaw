---
summary: "First-run onboarding flow for FoxClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give FoxClaw">
...
<Step title="CLI">
  ...
  The app can install the global `foxclaw` CLI via npm/pnpm so terminal
