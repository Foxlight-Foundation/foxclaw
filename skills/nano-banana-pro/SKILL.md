...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.foxclaw/foxclaw.json`
...
- The script prints a `MEDIA:` line for FoxClaw to auto-attach on supported chat providers.
