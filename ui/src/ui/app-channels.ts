...
function resolveNostrAccountId(host: FoxClawApp): string {
...
function resolveGatewayHttpAuthHeader(host: FoxClawApp): string | null {
...
function buildGatewayHttpHeaders(host: FoxClawApp): Record<string, string> {
...
export function handleNostrProfileCancel(host: FoxClawApp) {
...
export function handleNostrProfileToggleAdvanced(host: FoxClawApp) {
  const state = host.nostrProfileFormState;
  if (!state) {
    return;
  }
...
export async function handleNostrProfileSave(host: FoxClawApp) {
  const state = host.nostrProfileFormState;
...
export async function handleNostrProfileImport(host: FoxClawApp) {
  const state = host.nostrProfileFormState;
